...
import time
from Roomba.pycreate2.packets import SensorPacketDecoder
from Roomba.pycreate2.createSerial import SerialCommandInterface
from Roomba.pycreate2.OI import OPCODES
from Roomba.pycreate2.OI import DRIVE
...
class Create2(object):
    ...
    def get_sensors(self):
        ...
        if not msg == -1:
            # print(packet_byte_data) --> this prints some message if malformed data is returned
